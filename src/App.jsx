...
const templesData = [
  {
    ...
    audio: "https://res.cloudinary.com/dwbz8m9u8/video/upload/v1748250807/TIRUPATI_BALAJI_byvgku.mp3",
    ...
    festivals: [
      ...
      { name: "Rathasapthami", date_or_period: "February", description: "Celebrated as 'Mini Brahmotsavam' with the deity taken in procession on seven different vahanams." }
    ],
  },
...

  {
    ...
    darshan_tickets: {
      is_available_online: true,
      booking_link: "https://srisailamonline.com/",
      types_of_darshan: [
  ...
  },
  {
    ...
    darshan_tickets: {
      is_available_online: true,
      booking_link: "https://mahakaleshwar.nic.in/online-booking/",
      types_of_darshan: [
  ...
  },
  {
    ...
    entry_fee: "Free",
    website: "https://arunachaleswarartemple.tnhrce.gov.in/",
    darshan_tickets: {
  ...
  },
  {
    ...
    darshan_tickets: {
      is_available_online: true,
      booking_link: "https://srikalahasthitemple.org/online-sevas-booking/",
      types_of_darshan: [
  ...
  },
  {
    ...
    entry_fee: "Free",
    website: "https://chidambaramnatarajatemple.org/",
    darshan_tickets: {
      is_available_online: false,
      booking_link: null,
      types_of_darshan: [],
  ...
  // 1. Sankari Devi (Trincomalee, Sri Lanka) - Note: This is geographically outside India
  {
    ...
    location: {
      ...
      state: "Eastern Province", // Placeholder, as it's a different country
      country: "Sri Lanka",
  ...
  // 2. Kamakshi Devi, Kanchi (Kanchipuram, Tamil Nadu)
  {
    ...
    images: [
      ...
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748618833/IMG_20250530_192509_swxbm6.jpg", alt: "Kamakshi Devi Jyotilinga" }
    ],
  ...
  // 3. Sri Srunkhala Devi (West Bengal) - Note: Location details are debated, often associated with West Bengal
  {
    ...
    images: [
      ...
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748619573/IMG_20250530_192825_zhuswv.jpg", alt: "Sri Srunkhala Devi Jyotilinga" }
    ],
    audio: "https://res.cloudinary.com/dwbz8m9u8/video/upload/v1748688585/Aigiri_Nandini_New_tvm39p.mp3",
  ...
  // 4. Chamundeswari Devi, Mysore (Karnataka)
  {
    ...
    images: [
      ...
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748617600/IMG_20250529_084127_bg6vub.jpg", alt: "Chamundeshwari Devi Jyotilinga" }
    ],
    audio: "https://res.cloudinary.com/dwbz8m9u8/video/upload/v1748688585/Aigiri_Nandini_New_tvm39p.mp3",
  ...
  // 5. Jogulamba Devi, Alampur (Telangana)
  {
    ...
    images: [
      ...
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748618733/Alampur-Jogulamba-Temple-Gadwal-History-Timings-Ticket-Price_f2ywu9.jpg", alt: "Jogulamba Devi Jyotilinga" }
    ],
    audio: "https://res.cloudinary.com/dwbz8m9u8/video/upload/v1748688585/Aigiri_Nandini_New_tvm39p.mp3",
  ...
  // I will add a separate entry as requested, linking it to the existing Mallikarjuna if possible or creating a new one if not.
  {
    ...
    images: [
      ...
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748617528/IMG_20250529_081918_qt6xvk.png", alt: "Bramarambika Jyotilinga" }
    ],
    audio: "https://res.cloudinary.com/dwbz8m9u8/video/upload/v1748688585/Aigiri_Nandini_New_tvm39p.mp3",
  ...
  // 7. Mahalakshmi Devi, Kolhapur (Maharashtra)
  {
    ...
    images: [
      ...
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748619059/IMG_20250530_194458_ztwnha.jpg", alt: "Mahalakshmi Devi Jyotilinga" }
    ],
    audio: "https://res.cloudinary.com/dwbz8m9u8/video/upload/v1748688585/Aigiri_Nandini_New_tvm39p.mp3",
  ...
  // I will add a separate entry as requested, linking it to the existing Mahakaleshwar if possible or creating a new one if not.
  {
    ...
    images: [
      ...
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748618999/IMG_20250526_161427_qbzu1f.jpg", alt: "Mahakali Devi Jyotilinga" }
    ],
    audio: "https://res.cloudinary.com/dwbz8m9u8/video/upload/v1748688585/Aigiri_Nandini_New_tvm39p.mp3",
  ...
  // 10. Puruthika Devi, Pithapuram (Andhra Pradesh)
  {
    ...
    images: [
      ...
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748619104/IMG_20250529_081437_fk9ybe.jpg", alt: "Puruhutika Devi Jyotilinga" }
    ],
    audio: "https://res.cloudinary.com/dwbz8m9u8/video/upload/v1748688585/Aigiri_Nandini_New_tvm39p.mp3",
  ...
  // 11. Viraja Devi, Jajpur (Odisha) - Used your "Biraja Devi" spelling
  {
    ...
    images: [
      ...
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748618694/IMG_20250529_083728_uhhw7p.jpg", alt: "Biraja Devi Jyotilinga" }
    ],
    audio: "https://res.cloudinary.com/dwbz8m9u8/video/upload/v1748688585/Aigiri_Nandini_New_tvm39p.mp3",
  ...
  // 12. Kamarupa Devi, Guwahati (Assam) - Kamakhya Temple
  {
    ...
    category: "Shakti Peetha, Devi Temple, Tantric",
    ...
    images: [
      ...
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748618883/IMG_20250527_081522_s27s7v.jpg", alt: "Kamakhya Devi Jyotlinga" }
    ],
    audio: "https://res.cloudinary.com/dwbz8m9u8/video/upload/v1748688585/Aigiri_Nandini_New_tvm39p.mp3",
  ...
  // 13. Madhaveswari, Prayaga (Prayagraj, Uttar Pradesh)
  {
    ...
    images: [
      ...
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748618945/IMG_20250529_082345_sq2lmh.jpg", alt: "Madhaveswari Devi Jyotilinga" }
    ],
    audio: "https://res.cloudinary.com/dwbz8m9u8/video/upload/v1748688585/Aigiri_Nandini_New_tvm39p.mp3",
  ...
  // I will add a separate entry as requested for completeness, cross-referencing to the existing one.
  {
    ...
    images: [
      ...
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748618784/IMG_20250530_200421_fjxqh5.jpg", alt: "Jwala Devi Jyotilinga" }
    ],
    audio: "https://res.cloudinary.com/dwbz8m9u8/video/upload/v1748688585/Aigiri_Nandini_New_tvm39p.mp3",
  ...
  // 15. Sarvamangala Devi, Gaya (Bihar)
  {
    ...
    images: [
      ...
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748619299/IMG_20250530_200647_jhs64m.jpg", alt: "Sarvamangala Devi Jyotilinga" }
    ],
    audio: "https://res.cloudinary.com/dwbz8m9u8/video/upload/v1748688585/Aigiri_Nandini_New_tvm39p.mp3",
  ...
  // 16. Vishalakshi Devi, Varanasi (Uttar Pradesh)
  {
    ...
    images: [
      ...
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748619639/IMG_20250529_082739_f5cszf.jpg", alt: "Vishalakshi Devi Jyotilinga" }
    ],
    audio: "https://res.cloudinary.com/dwbz8m9u8/video/upload/v1748688585/Aigiri_Nandini_New_tvm39p.mp3",
  ...
  // I will add a separate entry as requested for completeness, cross-referencing to the existing one.
  {
    ...
    category: "Shakti Peetha, Devi Temple, Learning Center",
  ...
  // 18. Ratnavali (Ratnavali, West Bengal) - often associated with Ratnavali Peeth
  {
    id: "ratnavali-devi-wb",
    name: "Ratnavali Devi Temple",
    location: {
      city: "Khanakul", // Speculative location
      district: "Hooghly", // Placeholder
      state: "West Bengal",
      country: "India",
      coordinates: { latitude: 22.8200, longitude: 87.9100 } // Approximate
    },
    category: "Shakti Peetha, Devi Temple",
    deity: "Goddess Kumari", // As per some traditions at Ratnavali
    description: "Believed to be one of the Maha Shakti Peethas, though its precise location is also a subject of debate. It is associated with the falling of Sati's right shoulder.",
    history_summary: "The exact location and details of a definitive temple for Ratnavali Devi are not universally agreed upon, with various sites in West Bengal and other regions being proposed. This entry represents the general belief of a Shakti Peetha.",
    interesting_facts: [
      "Considered a Shakti Peetha where Sati's right shoulder (or other body part) is believed to have fallen.",
      "Often associated with the banks of the River Hooghly."
    ],
    architecture_style: "Not specifically defined (if current temple exists, it would be regional)",
    images: [
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748619157/IMG_20250530_201415_zscbjz.jpg", alt: "Ratnavali Devi Temple, West Bengal" },
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748619154/IMG_20250530_201347_lmnbya.jpg", alt: "Ratnavali Devi Jyotilinga" }
    ],
    audio: "https://res.cloudinary.com/dwbz8m9u8/video/upload/v1748688585/Aigiri_Nandini_New_tvm39p.mp3",
    famous_for: ["Maha Shakti Peetha"],
    rituals_practices: ["As per local traditions"],
  ...
  // --- END OF NEW 18 MAHA SHAKTI PEETHAS ENTRIES ---
  {
    ...
    darshan_tickets: {
      is_available_online: true,
      booking_link: "https://srjbtkshetra.org/e-darshan-booking/", // Example link, might need verification
      types_of_darshan: [
  ...
  },
  {
    ...
    darshan_tickets: {
      is_available_online: true,
      booking_link: "https://srirangam.org/online-booking/", // Example link, might need verification
      types_of_darshan: [
        { name: "General Darshan", cost: "Free" },
  ...
  },
  {
    ...
    architecture_style: "Dravidian",
    images: [
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748754689/IMG_20250526_140345_y9o8l7.jpg", alt: "Tirumala Venkateswara Temple" },
      { url: "https://res.cloudinary.com/dwbz8m9u8/image/upload/v1748754689/IMG_20250526_140212_q2hu7f.jpg", alt: "Tirumala Venkateswara Temple idol" }
    ],
  ...
  // New: Kalighat Temple
  {
    ...
    website: "https://kalighattemple.com/", // Example, actual might vary
    darshan_tickets: {
      is_available_online: false,
      booking_link: null,
      types_of_darshan: [],
  ...
  // --- NEW GUJARAT TEMPLE ENTRIES TO ADD TO YOUR 'templesData' ARRAY ---
  {
    ...
    website: "https://www.dwarkadhish.org/", // Official website if exists
    darshan_tickets: {
  ...
  // New: Akshardham Temple, Gandhinagar
  {
    ...
    entry_fee: "Free (exhibitions have fees)",
    website: "https://akshardham.com/gujarat/", // Example, actual might vary
    darshan_tickets: {
      is_available_online: false,
      booking_link: null,
      types_of_darshan: [],
  ...
  },
  {
    ...
    prasads: ["Laddu", "Daddojanam (Curd Rice)"],
    festivals: [
...
function ExploreTemplesPage({ onSelectTemple, categoryFilter, stateFilter, playAudio, pauseAudio, stopAudio, isPlaying, playingTempleId }) {
  ...
  if (categoryFilter) {
    ...
    } else if (categoryFilter === 'Shakti Peetha') {
      filteredTemples = templesData.filter(temple => temple.category.includes('Shakti Peetha'));
      pageTitle = "Explore 18 Shakti Peethas";
    ...
    const allSpecialCategoryIds = new Set([
      ...
      ...templesData.filter(t => t.category.includes('Shakti Peetha')).map(t => t.id),
  ...
  const handleAudioClick = (e, temple) => {
    e.stopPropagation(); // Prevent triggering onSelectTemple
    if (temple.audio) {
        ...
        {filteredTemples.map((temple, index) => (
          ...
          >
            ...
            <div className="flex flex-wrap gap-2 text-sm text-gray-600 mb-4">
              {temple.category.split(',').map((cat, i) => (
            ...
            {temple.audio && (
              <div className="flex gap-4">
                ...
                >
                  {playingTempleId === temple.id && isPlaying ? 'Pause' : 'Play'}
                </button>
                <button
...
function CategoriesPage({ onNavigateToExplore, onBack }) {
  const categories = [
    ...
    { title: "18 Shakti Peethas", filter: "Shakti Peetha", description: "Journey through the eighteen revered Shakti Peethas, where parts of Goddess Sati's body are believed to have fallen." },
